...
console.log(rows,"inside table comp");
...
function stableSort(array,data, comparator) {
...
export default function EnhancedTable({data, columns}) {
  console.log(data,"inside reusable table");
        ...
        <TableContainer>
          ...
          >
            ...
            <TableBody>
              ...
              {data&&data.length>0?(stableSort(rows,data, getComparator(order, orderBy))
